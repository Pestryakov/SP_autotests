export interface ProxyConfig {
  ...
  export const proxy: ProxyConfig[] = [
    ...
    { geo: 'Germany', server: '103.47.57.161:1229', login: 'user164888', password: 'f6qowk', localybrowser: "de" },
    ...
    { geo: 'UnitedKingdom', server: '5.83.211.152:5333', login: 'user164888', password: 'f6qowk', localybrowser: "en" },
  ];